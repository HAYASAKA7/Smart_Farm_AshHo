...
#define OV5640_MID              0X7FA2
#define OV5640_PID              0X2642
...
#define OV5640_SENSOR_PIDH       0x0A
#define OV5640_SENSOR_PIDL       0x0B
...
const rt_uint8_t OV5640_AUTOEXPOSURE_LEVEL[5][8]=
{
    {
        0xFF,0x01,
        0x24,0x20,
...
const rt_uint8_t ov5640_sxga_init_reg_tbl[][2]=
{
    {0xff, 0x00},
    {0x2c, 0xff},
    {0x2e, 0xdf},
...
/* SVGA 800*600 */
const rt_uint8_t ov5640_svga_init_reg_tbl[][2]=
{
    {0xff, 0x00},
    {0x2c, 0xff},
    {0x2e, 0xdf},
...
const rt_uint8_t ov5640_jpeg_reg_tbl[][2]=
{
    {0xff, 0x01},
    {0xe0, 0x14},
    {0xe1, 0x77},
...
const rt_uint8_t ov5640_rgb565_reg_tbl[][2]=
{
    {0xFF, 0x00},
    {0xDA, 0x09},
    {0xD7, 0x03},
...
const rt_uint8_t ov5640_yuv422_reg_tbl[][2] =
{
    {0xFF, 0x00},
    {0xDA, 0x10},
    {0xD7, 0x03},
