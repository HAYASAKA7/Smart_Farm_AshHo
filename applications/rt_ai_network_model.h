...
#define RT_AI_NETWORK_IN_SIZE_BYTES	{	\
	((AI_NETWORK_IN_1_SIZE * 4),	\
}
#define RT_AI_NETWORK_IN_1_SIZE			(28 *  28 *  1)
#define RT_AI_NETWORK_IN_1_SIZE_BYTES		((AI_NETWORK_IN_1_SIZE * 4)
#define RT_AI_NETWORK_IN_TOTAL_SIZE_BYTES		((AI_NETWORK_IN_1_SIZE * 4)
...
#define RT_AI_NETWORK_OUT_SIZE_BYTES	{	\
	((AI_NETWORK_OUT_1_SIZE * 4),	\
}
#define RT_AI_NETWORK_OUT_1_SIZE			(10)
#define RT_AI_NETWORK_OUT_1_SIZE_BYTES		((AI_NETWORK_OUT_1_SIZE * 4)
#define RT_AI_NETWORK_OUT_TOTAL_SIZE_BYTES		((AI_NETWORK_OUT_1_SIZE * 4)
